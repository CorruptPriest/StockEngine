...
class TariffAnalyzer:
    ...
    def analyze_stock_exposure(self, ticker, market, sector, industry):
        """Analyze how tariff events affect a specific stock"""
        ...
        for event in self.events:
            ...
            # Check if stock's country is targeted
            ...
            # Check if stock's country imposed tariffs (retaliatory impact)
    ...
    def get_portfolio_tariff_summary(self, portfolio_data):
        """Analyze entire portfolio for tariff exposure"""
        high_risk = []
        moderate_risk = []
        low_risk = []
        total_exposure = 0
...
class StockManagerGUI(ctk.CTk):
    ...
    def create_trade_tools_content(self, frame):
        ...
        self.rec_text = ctk.CTkTextbox(rec_frame, height=150, font=("Courier", 11))
    ...
    def create_tariffs_content(self, frame):
        ...
        self.tariff_impact_text = ctk.CTkTextbox(impact_frame, height=200, font=("Courier", 10))
